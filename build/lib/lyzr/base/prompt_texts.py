DATA_ANALYZR_PROMPTS = {
    "ai_queries": {
        "system": {
            ...
            # "task": "You MUST ensure that each query is simple, easy to understand, and can be answered with the data in the dataset.\n\nFollow this step-by-step guide:\n\n1. UNDERSTAND THE DATASET: Review the sample dataset provided to grasp its structure, variables, and context.\n2. GENERATE QUERIES: Create natural language queries for each applicable category: Exploratory Analysis, Regression Analysis, Correlation Analysis, Clustering Analysis, and Time Series Analysis.\n3. ENSURE RELEVANCE: Make sure every query is relevant to the data available in the dataset. Avoid hypothetical or non-applicable queries and categories.\n4. FORMAT IN JSON: Organize your queries into a JSON format as shown below:\n   ```json\n{schema}\n   ```\n\n",
            "closing": "Remember, I’m going to tip $300K for a BETTER SOLUTION!\n\nNow Take a Deep Breath.",
            # "task": "You will be provided the dataset sample for you to understand the context.\n\nYour queries fall in below categories:\nExploratory Analysis\nRegression Analysis\nCorrelation Analysis\nClustering Analysis\nTime Series Analysis\n\nSkip any categories that are not applicable.\n\n",
            # "json_type": "The queries should be simple and easy to understand.\nIt should be possible to answer every query with the data in the dataset.\nThe queries should be in natural language and should not contain any code or technical jargon.\nThe natural language queries should not explicitly mention the statistical model or chart type.\nDo NOT include hypothetical queries for which data is not present.\n\nYou should provide the queries in the following JSON format: {schema}",
        },
